(function() {
  ...
  function createBtn(img) {
    ...
    r_txt += '</div>';// .rc_tr1
    r_txt += '<div class="rc_tr2 flex f_bottom">';
    r_txt += '<div class="rc_td1">';
