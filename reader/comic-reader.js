(function() {
  ...
  function createBtn(img) {
    ...
    r_txt += '<style>.scrollToTop{display:none !important;}</style>'; //css hidden
  ...
  loadXMLDoc('https://bakomon.github.io/page/bookmark/comic-bookmark.js', function(res) { addScript(res, 'in'); });
