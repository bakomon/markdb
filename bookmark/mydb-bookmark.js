...
function mydb_bookmark() {
  ...
  function db_genData(note) {
    ...
    for (var i = 0; i < g_arr.length; i++) {
      ...
      if (g_arr[i] == 'alternative') g_val = g_val.replace(/\n/g, ' | ');
