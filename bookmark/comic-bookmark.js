(function() {
  ...
  function bc_showHtml(data, note) {
    ...
    var s_txt = '<ul>';
    s_txt += '<li class="_cm';
    if (data.similar != '' && note) s_txt += ' bc_similar';
