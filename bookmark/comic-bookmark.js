(function(d, w) {
  ...
  function startReader() {
    ...
    r_txt += '<style>.bc_mobile .reader_db{width:80%;}.bc_mobile .reader_db.bc_shide{left:-80%;}.bc_mobile ._rc{font-size:16px;}.bc_mobile .bc_toggle{right:-60px;width:60px;height:60px;}</style>'; //css mobile
