  ...
  function bc_checkComic(arr, chk) {
    ...
    for (var i = 0; i < arr.length; i++) {
      ...
      if (i == arr.length-1) {
        ...
        if (!chk) bc_checkComic(arr, 'double-check'); //double check if title not same as id
      }
    }
  }
