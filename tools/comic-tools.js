function comic_tools() {
  ...
  if (wh.search(host_rgx) != -1 && wp.indexOf('wp-content') == -1) {
    ...
    var tools_interval = 'manual|4/13/2021, 6:32:07 AM';
