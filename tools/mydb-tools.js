...
function mydb_tools_fnc() {
  ...
  getId = function(note) {
    ...
    titleId = titleId.replace(/\s?(man(ga|hwa|hua)|[kc]omi[kc]|novel|anime)\s?/i, '\x20'); /* multiple remove for komikid.com */
...
*/
/* ============================================================ */
var local_interval = 'manual|3/11/2022, 6:59:21 AM';
